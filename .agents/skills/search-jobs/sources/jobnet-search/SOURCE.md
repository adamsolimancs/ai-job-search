...
```bash
bun run .agents/skills/search-jobs/sources/jobnet-search/cli/src/cli.ts search [flags]
```
...
```bash
bun run .agents/skills/search-jobs/sources/jobnet-search/cli/src/cli.ts detail <jobAdId> [--format json|plain]
```
...
```bash
bun run .agents/skills/search-jobs/sources/jobnet-search/cli/src/cli.ts occupations --search-string <text> [--per-page <n>]
```
...
```bash
bun run .agents/skills/search-jobs/sources/jobnet-search/cli/src/cli.ts suggestions --query <text> [--limit <n>]
```
...
```bash
bun run .agents/skills/search-jobs/sources/jobnet-search/cli/src/cli.ts suggestions --query "syge"
bun run .agents/skills/search-jobs/sources/jobnet-search/cli/src/cli.ts occupations --search-string "sygeplejerske"
```
...
```bash
bun run .agents/skills/search-jobs/sources/jobnet-search/cli/src/cli.ts search \
...
```bash
bun run .agents/skills/search-jobs/sources/jobnet-search/cli/src/cli.ts detail 9ef43bce-d82b-4ea1-a098-7ff6520f99be --format plain
```
...
```bash
bun run .agents/skills/search-jobs/sources/jobnet-search/cli/src/cli.ts suggestions --query "ingeniør" --limit 5
bun run .agents/skills/search-jobs/sources/jobnet-search/cli/src/cli.ts occupations --search-string "lærer" --per-page 5
```
